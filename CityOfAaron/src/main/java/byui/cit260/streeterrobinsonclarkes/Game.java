...
public class Game implements Serializable {
    ...
    public int hashCode() {
        int hash = 5;
        hash = 19 * hash + Objects.hashCode(this.thePlayer);
        hash = 19 * hash + Objects.hashCode(this.theMap);
        hash = 19 * hash + Objects.hashCode(this.theStorehouse);
        hash = 19 * hash + this.currentPopulation;
        hash = 19 * hash + this.acresOwned;
        hash = 19 * hash + this.wheatInStorage;
        return hash;
    }
